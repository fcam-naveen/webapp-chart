...
- [Step 2 — Expose the ArgoCD UI](#step-2--expose-the-argocd-ui)
- [Step 3 — Open the ArgoCD UI](#step-3--open-the-argocd-ui)
- [Step 4 — Deploy the App via ArgoCD](#step-4--deploy-the-app-via-argocd)
- [Step 5 — Access the Web App](#step-5--access-the-web-app)
- [Making a Change and Seeing It Apply](#making-a-change-and-seeing-it-apply)
